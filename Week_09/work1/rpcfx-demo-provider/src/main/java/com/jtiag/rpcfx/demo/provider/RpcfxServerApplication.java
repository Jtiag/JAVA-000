...
import com.jtiag.rpcfx.api.RpcfxResolver;
import com.jtiag.rpcfx.api.RpcfxResponse;
import com.jtiag.rpcfx.api.ServiceProviderDesc;
import com.jtiag.rpcfx.server.RpcfxInvoker;
...
public class RpcfxServerApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String userService = "com.jtiag.rpcfx.demo.api.UserService";
        registerService(client, userService);
        String orderService = "com.jtiag.rpcfx.demo.api.OrderService";
    ...
    @Bean(name = "com.jtiag.rpcfx.demo.api.UserService")
    public UserService createUserService() {
        return new UserServiceImpl();
    }

    @Bean(name = "com.jtiag.rpcfx.demo.api.OrderService")
