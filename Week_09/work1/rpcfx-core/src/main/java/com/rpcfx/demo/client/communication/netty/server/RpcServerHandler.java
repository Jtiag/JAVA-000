...
package com.rpcfx.demo.client.communication.netty.server;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.rpcfx.demo.api.RpcfxRequest;
import com.rpcfx.demo.api.RpcfxResponse;
import com.rpcfx.demo.api.execption.RpcfxException;
import com.rpcfx.demo.client.communication.netty.common.RpcProtocol;
...
public class RpcServerHandler extends SimpleChannelInboundHandler<RpcProtocol> {
    ...
    private RpcfxResponse invoke(RpcfxRequest request) {
        ...
        // 作业1：改成泛型和反射
        String substring = serviceClass.substring(serviceClass.lastIndexOf(".") + 1);
